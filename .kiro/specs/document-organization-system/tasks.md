...
- [ ] 8. 重要度評価の実装
  - [x] 8.1 ImportanceEvaluatorクラスを実装
    - 参照数スコアの計算
    - 最新性スコアの計算
    - カテゴリスコアの計算
    - 重複ペナルティの計算
...
- [ ] 16. Workflow統合
  - [x] 16.1 workflow.mdファイルを作成
    - ワークフロー定義
    - ステップの説明
    - ユーザー確認ポイント
    - _Requirements: 12.1, 12.2, 12.3, 12.4_
  
  - [x] 16.2 ワークフローロギングを実装
    - すべてのアクションのログ記録
    - タイムスタンプの追加
    - 監査証跡の生成
    - _Requirements: 12.5_
